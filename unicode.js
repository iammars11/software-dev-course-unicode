...
let swappedString = String.fromCharCode(inputString2.charCodeAt(inputString2.length - 1)) + inputString2.slice(1, -1) + String.fromCharCode(inputString2.charCodeAt(0)); // last char = "h" // "aunc" // first char = "L"
